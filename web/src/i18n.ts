...
const BN: Record<string, string> = {
  ...
  Approved: 'অনুমোদিত',
  'This Week': 'এই সপ্তাহ',
  'Revenue Trend': 'আয়ের ধারা',
  'Due Pipeline': 'বকেয়া পাইপলাইন',
  Critical: 'জটিল',
  'No rows found': 'কোনো সারি পাওয়া যায়নি',
  'New leads this week': 'এই সপ্তাহে নতুন লিড',
  'payments this week': 'এই সপ্তাহের পেমেন্ট',
  'new bookings this week': 'এই সপ্তাহে নতুন বুকিং',
  'No payments yet': 'এখনো কোনো পেমেন্ট নেই',
  'accounts tracked': 'টি অ্যাকাউন্ট ট্র্যাক করা হচ্ছে',
