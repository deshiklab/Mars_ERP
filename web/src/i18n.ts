...
const BN: Record<string, string> = {
  ...
  Projects: 'প্রকল্প',
  'Land & Projects': 'জমি ও প্রকল্প',
  Bookings: 'বুকিং',
  'Bookings & Customer': 'বুকিং ও গ্রাহক',
  Engineering: 'ইঞ্জিনিয়ারিং',
  'Engineering & Construction': 'ইঞ্জিনিয়ারিং ও নির্মাণ',
  Accounts: 'হিসাব',
  'Accounts & Finance': 'হিসাব ও অর্থ',
  Admin: 'অ্যাডমিন',
  'Admin & Operations': 'অ্যাডমিন ও অপারেশন',
  Legal: 'আইনি',
  'Legal & Compliance': 'আইনি ও সম্মতি',
  Collaboration: 'সহযোগিতা',
  System: 'সিস্টেম',
  Communication: 'যোগাযোগ',
  'Communication & AI': 'যোগাযোগ ও এআই',
  'Total Units': 'মোট ইউনিট',
  'Total Value': 'মোট মূল্য',
  'All Projects': 'সব প্রজেক্ট',
  'Payment Schedule': 'পেমেন্ট শিডিউল',
  'Payment Summary': 'পেমেন্ট সারাংশ',
  'Total Price': 'মোট মূল্য',
  'Advance Paid': 'অগ্রিম প্রদান',
  'Payment Promises': 'পেমেন্ট প্রতিশ্রুতি',
  'Keyboard Shortcuts': 'কীবোর্ড শর্টকাট',
  'Mark Booking': 'বুকিং চিহ্নিত করুন',
  'Mark Paid': 'পরিশোধিত চিহ্নিত করুন',
  'Mark Overdue': 'অতিরিক্ত সময় চিহ্নিত করুন',
  'Go to Dashboard': 'ড্যাশবোর্ডে যান',
  'Waiting for server data': 'সার্ভার ডেটার জন্য অপেক্ষা',
  'Sales Config': 'সেলস কনফিগ',
  'Territories': 'অঞ্চলসমূহ',
  'Sales Targets': 'বিক্রয় লক্ষ্য',
  'Pipeline Stages': 'পাইপলাইন ধাপ',
  'Plot Pricing Rates': 'প্লট মূল্য হার',
  ...
  'Sold': 'বিক্রিত',
  'Reserved': 'সংরক্ষিত',
  'Under Payment': 'পরিশোধ চলছে',
  'Monthly Collections': 'মাসিক আদায়',
  'Collections': 'আদায়',
  'Invoices': 'চালান',
  ...
  'Hot Leads': 'গরম লিড',
  'Dues Reminders': 'বকেয়া রিমাইন্ডার',
